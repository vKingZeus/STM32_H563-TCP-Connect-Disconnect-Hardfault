...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA0     ------> ADC1_INP0
    */
    GPIO_InitStruct.Pin = TO_MSPADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(TO_MSPADC_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA0     ------> ADC1_INP0
    */
    HAL_GPIO_DeInit(TO_MSPADC_GPIO_Port, TO_MSPADC_Pin);
...
void HAL_ETH_MspInit(ETH_HandleTypeDef* heth)
{
  ...
  /* USER CODE END ETH_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = ETH_TXT_EN_Pin|ETH_TXD0_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF11_ETH;
...
void HAL_ETH_MspDeInit(ETH_HandleTypeDef* heth)
{
  ...
  /* USER CODE END ETH_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOG, ETH_TXT_EN_Pin|ETH_TXD0_Pin);
